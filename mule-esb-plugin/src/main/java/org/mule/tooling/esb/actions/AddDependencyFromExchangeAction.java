...
import org.mule.tooling.esb.exchange.ui.ExchangeDependencyDialog;
...
public class AddDependencyFromExchangeAction extends AnAction {
    ...
    public AddDependencyFromExchangeAction() {
        super("Add Dependency from Exchange", "Adds connector or extension dependency from Anypoint Exchange", MuleIcons.AnypointExchangeIcon);
    }
